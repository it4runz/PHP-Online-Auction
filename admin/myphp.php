...
$tmp_name=$_FILES["image"]["tmp_name"];
	 ...
	 $query="INSERT INTO `books`(`isbn`, `Title`, `Author`,`book_rating`, `image`, `discription`, `price`, `publisher`)
...
if(empty($name))
{
	$query="UPDATE `books` SET `isbn`='$uisbn',`Title`='$utitle',`Author`='$uauthor',`book_rating`='$urating',
`discription`='$udiscription',`price`='$uprice',`publisher`='$upublisher' WHERE bookid='$uid'";
